...
public class PilnyiPoroshokItem extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:pilnyi_poroshok")
	public static final Item block = null;

	public PilnyiPoroshokItem(HorrormodModElements instance) {
		super(instance, 192);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("pilnyi_poroshok");
		}
