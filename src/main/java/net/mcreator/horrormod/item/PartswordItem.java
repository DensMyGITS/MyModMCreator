...
public class PartswordItem extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:partsword")
	public static final Item block = null;

	public PartswordItem(HorrormodModElements instance) {
		super(instance, 328);
	}
