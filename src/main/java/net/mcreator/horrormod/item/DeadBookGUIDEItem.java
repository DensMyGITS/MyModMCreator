...
import net.mcreator.horrormod.gui.GUIBOOKSGuiWindow;
...
public class DeadBookGUIDEItem extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:dead_book_guide")
	public static final Item block = null;

	public DeadBookGUIDEItem(HorrormodModElements instance) {
		super(instance, 109);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof GUIBOOKSGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("dead_book_guide");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Dead Book GUIDE");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GUIBOOKSGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
