...
public class DeadIngotItem extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:dead_ingot")
	public static final Item block = null;

	public DeadIngotItem(HorrormodModElements instance) {
		super(instance, 66);
	}
