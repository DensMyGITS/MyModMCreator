...
public class ParthoeItem extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:parthoe")
	public static final Item block = null;

	public ParthoeItem(HorrormodModElements instance) {
		super(instance, 331);
	}
