...
public class OchisennyiHoeItem extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:ochisennyi_hoe")
	public static final Item block = null;

	public OchisennyiHoeItem(HorrormodModElements instance) {
		super(instance, 322);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("ochisennyi_hoe"));
	}
}
