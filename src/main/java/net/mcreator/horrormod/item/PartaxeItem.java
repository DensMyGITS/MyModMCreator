...
public class PartaxeItem extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:partaxe")
	public static final Item block = null;

	public PartaxeItem(HorrormodModElements instance) {
		super(instance, 329);
	}
