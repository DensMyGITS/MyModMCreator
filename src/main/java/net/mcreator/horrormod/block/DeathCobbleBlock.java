...
public class DeathCobbleBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_cobble")
	public static final Block block = null;

	public DeathCobbleBlock(HorrormodModElements instance) {
		super(instance, 25);
	}
