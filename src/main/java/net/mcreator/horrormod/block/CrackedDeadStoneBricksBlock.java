...
public class CrackedDeadStoneBricksBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:cracked_dead_stone_bricks")
	public static final Block block = null;

	public CrackedDeadStoneBricksBlock(HorrormodModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cracked_dead_stone_bricks");
		}
