...
public class DeathWOODWoodBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_wood")
	public static final Block block = null;

	public DeathWOODWoodBlock(HorrormodModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("death_wood_wood");
		}
