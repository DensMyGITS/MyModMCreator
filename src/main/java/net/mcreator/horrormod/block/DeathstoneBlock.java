...
public class DeathstoneBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:deathstone")
	public static final Block block = null;

	public DeathstoneBlock(HorrormodModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DeathCobbleBlock.block));
		}
	}
}
