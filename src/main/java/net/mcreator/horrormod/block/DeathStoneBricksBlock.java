...
public class DeathStoneBricksBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_stone_bricks")
	public static final Block block = null;

	public DeathStoneBricksBlock(HorrormodModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("death_stone_bricks");
		}
