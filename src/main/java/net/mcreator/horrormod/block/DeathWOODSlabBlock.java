...
public class DeathWOODSlabBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_slab")
	public static final Block block = null;

	public DeathWOODSlabBlock(HorrormodModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("death_wood_slab");
		}
