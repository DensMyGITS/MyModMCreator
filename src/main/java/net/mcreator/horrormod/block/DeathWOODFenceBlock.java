...
public class DeathWOODFenceBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_fence")
	public static final Block block = null;

	public DeathWOODFenceBlock(HorrormodModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("death_wood_fence");
		}
