...
public class DeadStoneBricksSlabBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:dead_stone_bricks_slab")
	public static final Block block = null;

	public DeadStoneBricksSlabBlock(HorrormodModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_stone_bricks_slab");
		}
