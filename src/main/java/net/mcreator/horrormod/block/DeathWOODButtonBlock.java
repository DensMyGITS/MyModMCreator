...
public class DeathWOODButtonBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_button")
	public static final Block block = null;

	public DeathWOODButtonBlock(HorrormodModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("death_wood_button");
		}
