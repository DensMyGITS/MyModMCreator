...
public class DeathWOODLogBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_log")
	public static final Block block = null;

	public DeathWOODLogBlock(HorrormodModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("death_wood_log");
		}
