...
public class DeathWOODPressurePlateBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_pressure_plate")
	public static final Block block = null;

	public DeathWOODPressurePlateBlock(HorrormodModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("death_wood_pressure_plate");
		}
