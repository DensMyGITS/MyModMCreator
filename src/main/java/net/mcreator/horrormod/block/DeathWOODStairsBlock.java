...
public class DeathWOODStairsBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_stairs")
	public static final Block block = null;

	public DeathWOODStairsBlock(HorrormodModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("death_wood_stairs");
		}
