...
public class PolishedDeadStoneBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:polished_dead_stone")
	public static final Block block = null;

	public PolishedDeadStoneBlock(HorrormodModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_dead_stone");
		}
