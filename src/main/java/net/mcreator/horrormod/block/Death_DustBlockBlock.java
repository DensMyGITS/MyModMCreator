...
public class Death_DustBlockBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_dust_block")
	public static final Block block = null;

	public Death_DustBlockBlock(HorrormodModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("death_dust_block");
		}
