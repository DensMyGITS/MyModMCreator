...
public class DeathWOODLeavesBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_leaves")
	public static final Block block = null;

	public DeathWOODLeavesBlock(HorrormodModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("death_wood_leaves");
		}
