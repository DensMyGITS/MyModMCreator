...
public class DeadBricksWallBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:dead_bricks_wall")
	public static final Block block = null;

	public DeadBricksWallBlock(HorrormodModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_bricks_wall");
		}
