...
public class DeathWOODFenceGateBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_fence_gate")
	public static final Block block = null;

	public DeathWOODFenceGateBlock(HorrormodModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("death_wood_fence_gate");
		}
