...
public class KEY5Block extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:key_5")
	public static final Block block = null;

	public KEY5Block(HorrormodModElements instance) {
		super(instance, 290);
	}
