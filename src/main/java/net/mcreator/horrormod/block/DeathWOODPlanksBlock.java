...
public class DeathWOODPlanksBlock extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_wood_planks")
	public static final Block block = null;

	public DeathWOODPlanksBlock(HorrormodModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("death_wood_planks");
		}
