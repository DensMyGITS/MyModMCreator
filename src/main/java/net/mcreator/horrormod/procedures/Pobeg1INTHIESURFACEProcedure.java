...
public class Pobeg1INTHIESURFACEProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				HorrormodMod.LOGGER.warn("Failed to load dependency entity for procedure Pobeg1INTHIESURFACE!");
			return;
		}
		...
		if (entity instanceof PlayerEntity) {
			if (((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(TrofeiBlock.block)) : false)
					&& (entity.world.getDimensionKey()) == (World.OVERWORLD)) {
