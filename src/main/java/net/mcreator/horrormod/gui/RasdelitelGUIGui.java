...
import net.mcreator.horrormod.procedures.RasdelProcedutreProcedure;
...
public class RasdelitelGUIGui extends HorrormodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public RasdelitelGUIGui(HorrormodModElements instance) {
		super(instance, 337);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("rasdelitel_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, RasdelitelGUIGuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			RasdelProcedutreProcedure.executeProcedure(Stream
