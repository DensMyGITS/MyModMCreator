...
import net.mcreator.horrormod.procedures.ProcGUISoedProcedure;
...
public class NewGUISoedinitelGui extends HorrormodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public NewGUISoedinitelGui(HorrormodModElements instance) {
		super(instance, 333);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("new_gui_soedinitel"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, NewGUISoedinitelGuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			ProcGUISoedProcedure.executeProcedure(Stream
