...
import net.mcreator.horrormod.procedures.TestOchist2Procedure;
...
public class OchistGUIGui extends HorrormodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public OchistGUIGui(HorrormodModElements instance) {
		super(instance, 215);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("ochist_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, OchistGUIGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 151, 62) {
			}));
			...
			this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 79, 26) {
				@Override
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			TestOchist2Procedure.executeProcedure(Stream
