...
import net.mcreator.horrormod.procedures.CraftTableObnovitTaktProcedure;
...
public class DarkCraftGUIGui extends HorrormodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public DarkCraftGUIGui(HorrormodModElements instance) {
		super(instance, 175);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("dark_craft_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, DarkCraftGUIGuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			CraftTableObnovitTaktProcedure.executeProcedure(Stream
