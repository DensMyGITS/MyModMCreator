...
import net.mcreator.horrormod.procedures.OchistGUIProcedNEWProcedure;
...
public class OchistGUINEWGui extends HorrormodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public OchistGUINEWGui(HorrormodModElements instance) {
		super(instance, 310);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("ochist_guinew"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, OchistGUINEWGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 151, 35) {
			}));
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 151, 62) {
			}));
			this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 79, 8) {
			}));
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				HorrormodMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			OchistGUIProcedNEWProcedure.executeProcedure(Stream
