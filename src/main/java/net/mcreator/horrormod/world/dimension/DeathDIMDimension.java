...
import net.mcreator.horrormod.procedures.DeathDIMIesliIghrokVkhoditVIzmierieniieProcedure;
import net.mcreator.horrormod.procedures.DeathDIMIesliIghrokPokidaietIzmierieniieProcedure;
...
public class DeathDIMDimension extends HorrormodModElements.ModElement {
	@ObjectHolder("horrormod:death_dim_portal")
	public static final CustomPortalBlock portal = null;

	public DeathDIMDimension(HorrormodModElements instance) {
		super(instance, 26);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(DeathblockBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("horrormod:dead_woods_biome")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getTop().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("horrormod:dead_woods_biome")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getUnder().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("horrormod:death")).getGenerationSettings().getSurfaceBuilder()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("horrormod:death_dim"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("death_dim_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("death_dim_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("death_dim_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new DeathDIMItem().setRegistryName("death_dim"));
	}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					...
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("horrormod:death_dim")));
				} else {
					entity.func_242279_ag();
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getFrom() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("horrormod:death_dim"))) {

			DeathDIMIesliIghrokPokidaietIzmierieniieProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("horrormod:death_dim"))) {

			DeathDIMIesliIghrokVkhoditVIzmierieniieProcedure.executeProcedure(Stream
