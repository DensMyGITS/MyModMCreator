...
package net.mcreator.horrormod.world.biome;
...
public class DIMBIOME1Biome extends HorrormodModElements.ModElement {
	public static Biome biome;

	public DIMBIOME1Biome(HorrormodModElements instance) {
		super(instance, 250);
			...
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.PODZOL.getDefaultState(),
								Blocks.COARSE_DIRT.getDefaultState(), Blocks.MOSSY_COBBLESTONE.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.CRYING_OBSIDIAN.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.BUBBLE_COLUMN.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("horrormod:dimbiome_1"));
			}
		}
	}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("dimbiome_1_ctd");
