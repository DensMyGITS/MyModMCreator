...
package net.mcreator.horrormod.entity;
...
import net.mcreator.horrormod.entity.renderer.FlyingMobRenderer;
...
public class FlyingMobEntity extends HorrormodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("flying_mob").setRegistryName("flying_mob");

	public FlyingMobEntity(HorrormodModElements instance) {
		super(instance, 179);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FlyingMobRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("flying_mob_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("horrormod:death").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(1, new Goal() {
				...
				public void startExecuting() {
					...
					CustomEntity.this.moveController.setMoveTo(vec3d.x, vec3d.y, vec3d.z, 0.5);
				}
			...
			this.goalSelector.addGoal(2, new RandomWalkingGoal(this, 0.5, 20) {
				@Override
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(PilnyiPoroshokItem.block));
		}
