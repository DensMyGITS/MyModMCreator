...
import net.mcreator.horrormod.entity.renderer.DeadSkeletRenderer;
import net.mcreator.horrormod.HorrormodModElements;

@HorrormodModElements.ModElement.Tag
public class DeadSkeletEntity extends HorrormodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("dead_skelet").setRegistryName("dead_skelet");

	public DeadSkeletEntity(HorrormodModElements instance) {
		super(instance, 178);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DeadSkeletRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10066330, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("dead_skelet_spawn_egg"));
	}
